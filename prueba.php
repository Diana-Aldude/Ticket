        ...
        <div class="col-lg-12">
          ...
          <div class="card-body">
                   ...
                   <?php
                        ...
                        include 'buscador/buscadorcid.php';
                 ?>
           </div>
           ...
           <!--Seleccionador de nombres -->
                ...
                <div class="form-row" >
                  ...
                  <div class="col-md-6 mb-3 " >
                    ...
                    <select name="cc" type="text" class="form-control" id="cc" class="custom-select">
                      ...
                      <option value="solicitudes_postventa_fija_corporativa@claro.com.pe; SoporteConfiguracionesSSGG@claro.com.pe">BOCS</option>
                      <option value="solicitudes_postventa_fija_corporativa@claro.com.pe; SoporteConfiguracionesSSGG@claro.com.pe">CLIENTE O PENDIENTE</option>
                    </select>
                  </div>
                ...
                <button id="enviarresponsiva" class="btn btn-outline-danger" type="submit" value="Responsiva">Responsiva</button>
